namespace NewInterpolation
{
    partial class ErrorMessadge
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ErrorMessadge));
            ...
            this.label4.Text = "дискретизувати сигнал певною частотою";
            // 
            // label5
            // 
            ...
            this.label5.Text = "Перш ніж робити інтерполяцію, потрібно";
            // 
            // label3
            // 
            ...
            this.label3.Text = "вказати частоту та амплітуду сигналу";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Щоб виконати дискретизацію, потрібно";
            // 
            // label1
            // 
            ...
            this.label1.Text = "Здається, не було введено необхідні дані :)";
            // 
            // ErrorMessadge
            // 
